# attributor — a Model Meets Reality starter
...
> For each outcome, name the cause AND the leading rival cause, and the observation that discriminates between them.

And when a claim comes due:

> Did the discriminating observation favour the named cause or the rival?
...
python -m suites.new_model my-model --kind attributor \
